...
// http://localhost:3002 solo publica su remoteEntry.js y muestra este aviso:
// sin el shell no hay token, usuario ni onLogout que entregarle. No monta
// AdminApp ni inventa credenciales de desarrollo.
  ...
  return (
    <main>
      ...
      <p>
        ...
        sesion con una cuenta ADMIN para usar el modulo Administracion.
      </p>
    </main>
  );
}
