...
/**
 * Valida el JWT HS256 del proyecto. Copiado de ms-reservas sin tocar la logica de
 ...
 *
 * ms-reportes no emite tokens de sesion, por eso esta copia no lleva el metodo emitir ni la
 * propiedad jwt.vigencia-horas; el emisor es ms-usuarios (design seccion 5.2). El unico token
 * que ms-reportes si emite es el de servicio hacia ms-canchas y ms-reservas, y de eso se
 * encarga EmisorTokenServicio (design seccion 5.3).
 */
@Service
