...
// Diseno seccion 5.7: toda respuesta de error sale de aqui con la forma
...
// un unico envoltorio de ReservasApp, que llama onLogout (D-13).
...
// PATCH sin cuerpo: la ruta ya expresa la operacion y el contrato no declara
// ningun campo de entrada.
export function parchear(apiBaseUrl, ruta, token) {
  return pedir(apiBaseUrl, ruta, { metodo: "PATCH", token: token });
}
