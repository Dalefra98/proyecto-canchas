 ...
 *
 * Unica diferencia con la copia de ms-canchas: un token con rol SERVICIO se rechaza
 * (supuesto S-12). ms-reservas emite ese rol hacia ms-canchas, pero no lo acepta de vuelta:
 * ninguno de sus endpoints se consume asi, y una operacion sin claim sub no tiene dueno con
 * el que comprobar RN-03.
 */
@Component
