...
import ec.ups.dae.reportes.service.TokenService;
 ...
 *
 * Copia de la de ms-reservas, incluido el rechazo del rol SERVICIO, que aqui se conserva
 * tal cual (decision P-11): ningun microservicio consume ms-reportes, y un reporte no tiene
 * dueno con el que comprobar nada. ms-reportes EMITE tokens de servicio hacia ms-canchas y
 * ms-reservas, pero no los acepta de vuelta. Esa asimetria esta escrita en
 * docs/contratos/README.md desde el 23/08/2026.
 */
@Component
public class FiltroToken extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest peticion, HttpServletResponse respuesta,
        ...
        if (encabezado != null && encabezado.startsWith(PREFIJO)) {
            ...
            if (claims != null && !ROL_SERVICIO.equals(tokenService.rolDe(claims))) {
